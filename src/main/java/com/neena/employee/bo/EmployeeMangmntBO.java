package com.neena.employee.bo;



public class EmployeeMangmntBO {
	...
	public EmployeeMangmntBO() { 
		super();
		// TODO Auto-generated constructor stub
	}
	public EmployeeMangmntBO(String id, Integer employeeId,
	...
	public String toString() {
		return "EmployeeMangmntBO [id=" + id + ", employeeId=" + employeeId
