...
/**
 * Model class that has connection with UI
 * @author 144895
 *
 */
public class EmployeeMgmtDTO {
	...
	public EmployeeMgmtDTO() {
		
	}


	public EmployeeMgmtDTO(String employeeId, String name, String joiningDate,
