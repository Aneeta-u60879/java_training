package com.springBoot.employManagement;
...
@EnableSwagger2
@Configuration
public class EmployManagementApplication extends WebMvcConfigurerAdapter {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors
						.basePackage("com.springBoot.employManagement.controller"))
